...
var data = { "Étlap":{ "Pizzák":{ "Margarita pizza":{ "Összetevők":"blah blah",
        "Árak":{ "30cm":1070,
          "40cm":2070,
          "50cm":2970 },
        "Választható":[ "Pizzafeltétek" ] },
      "Sonkás pizza":{ "Összetevők":"blah blah",
        "Árak":{ "30cm":1070,
          "40cm":2070,
          "50cm":2970 },
        "Választható":[ "Pizzafeltétek" ] } },
    "Extra pizzák":{ "Három kívánság pizza":{ "Összetevők":"blah blah",
        "Árak":{ "30cm":1190,
          "40cm":2450,
          "50cm":3540 },
        "Választható":[ "Pizzaalapok",
          "3K-Pizzafeltétek" ] } } },
  "Extrák":{ Pizzaalapok:[ "paradicsomos",
      "tejfölös",
      "mézes mutáros",
      "mustáros",
      "fokhagymás tejfölös",
      "fokhagymás mustáros tejfölös",
      "fokhagymás paradicsomos" ],
    "Pizzafeltétek":{ "Húsok":{ "Ár":250,
        "Választék":[ "sonka",
          "tarja",
          "bacon",
          "szalámi",
      ...
      "Gyümölcsök":{ "Ár":150,
        "Választék":[ "ananász",
          "citrom" ] } },
    "Hamburgerfeltétek":{ "Zöldségek":{ "Ár":100,
        "Választék":[ "jégsaláta",
          "paradicsom",
          "uborka" ] },
      "Húsok":{ "Ár":300,
        "Választék":[ "Húspogácsa" ] },
      Sajtok:{ "Ár":150,
        "Választék":[ "parmezán",
          "gorgonzola",
          "cheddar" ] } } } };

var register = function (Vue) {
    Vue.component('fb-box', {
        ...
        ready: function ready() {
            ...
            window.addEventListener('resize', function () { return this$1.resize(); });
            this.resize();
        },
        methods: {
...
var register$1 = function (Vue) {
    Vue.component('google-map', {
        ...
        ready: function ready() {
            ...
            this.calcSrc();
            window.addEventListener('resize', function () { return this$1.calcSrc(); });
        },
        methods: {
            calcSrc: function calcSrc() {
                var width = this.$el.parentNode.clientWidth | 0;
                if (!width) { return; }
...
var AddToCart = Vue.component('add-cart', {
...
var PizzaDetails = Vue.component('pizza-details', {
    replace: false,
    props: ['name', 'category'],
...
var ChooseDetails = Vue.component('choose-details', {
    replace: false,
    props: ['dish'],
    template: '<h1>{{ dish.name }} {{ dish.category }} {{ dish.variant }}</h1><button @click="cancel">Back</button>',
    ready: function ready() {
        var menu = store.getState().menu;
        var menuDish = menu[this.dish.category][this.dish.name];
        var options = menuDish['Választható'];
...
var vm = new Vue({
    ...
    methods: {
        addToCart: function addToCart$1(product) {
