...
var data = { "Húsok":{ "Ár":250,
    "Választék":[ "sonka",
      ...
      "csirkemell" ] },
  "Halféleségek":{ "Ár":300,
    "Választék":[ "tengergyümölcsei",
      "tonhal" ] },
  "Prémium sonkák":{ "Ár":450,
    "Választék":[ "pármai",
      "serrano",
      "mangalica" ] },
  "Tejes készítmények, sajtok":{ "Ár":250,
    "Választék":[ "tejföl",
      "juhtúró",
      "sajt",
      "füstölt sajt" ] },
  "Prémium sajtok":{ "Ár":300,
    "Választék":[ "gorgonzola sajt",
      "parmezán sajt",
      "mozzarella golyó",
      "feta sajt" ] },
  "Zöldségek":{ "Ár":150,
    "Választék":[ "kukorica",
      ...
      "póréhagyma",
      "capribogyó",
      "fehér és vörös óriásbab",
      "édes pepperóni",
      "erős cseresznyepaprika",
      "jalapeno paprika",
      "padlizsán",
      "cukkini",
      "répa",
      "pritamin paprika",
      "magozott zöld és fekete olívabogyó",
      "ruccola",
      "paradicsom",
      "brokkoli" ] },
  "Gyümölcsök":{ "Ár":150,
...
var jquery$1 = interopDefault(jquery);
...
var navi = createCommonjsModule(function (module) {
var $ = interopDefault(require$$0);
...
var navi$1 = interopDefault(navi);
var init = navi.init;
...
var vClass = {
  ...
  handleObject: function handleObject(value) {
    ...
    for (var i = 0, l = keys.length; i < l; i++) {
      var key = keys[i];
      if (value[key]) {
        addClass(this$1.el, key);
      } else {
        removeClass(this$1.el, key);
      }
    }
  },
...
function miscMixin (Vue) {
  ...
  Vue.prototype._applyFilters = function (value, oldValue, filters, write) {
    ...
    for (i = 0, l = filters.length; i < l; i++) {
      filter = filters[i];
      fn = resolveAsset(this$1.$options, 'filters', filter.name);
      if ("production" !== 'production') {}
      if (!fn) continue;
...
var vue_common$1 = interopDefault(vue_common);


var require$$13 = Object.freeze({
  default: vue_common$1
});
...
var tokensToRegExp = index$4.tokensToRegExp;
var tokensToFunction = index$4.tokensToFunction;
var compile = index$4.compile;
var parse = index$4.parse;
...
/* globals require, module */
  ...
  var pathtoRegexp = interopDefault(require$$0$1);
...
var baseProperty = interopDefault(require$$2$1);
...
var isObject = interopDefault(require$$0$6);
...
var getLength = interopDefault(require$$2),
    ...
    isLength = interopDefault(require$$3$1);
...
var isObjectLike$1 = createCommonjsModule(function (module) {
/**
 * Checks if `value` is object-like. A value is object-like if it's not `null`
 * and has a `typeof` result of "object".
 *
...
var isArrayLike = interopDefault(require$$0$5),
    isObjectLike = interopDefault(require$$0$7);
...
var isArrayLikeObject = interopDefault(require$$0$4);
...
var arrayPush = interopDefault(require$$3),
    isArguments = interopDefault(require$$7),
    isArray = interopDefault(require$$0$8),
    isArrayLikeObject = interopDefault(require$$0$4);
...
var eq = interopDefault(require$$0$12);
...
var _assocDelete = createCommonjsModule(function (module) {
var assocIndexOf = interopDefault(require$$0$11);
...
var _assocDelete$1 = interopDefault(_assocDelete);


var require$$2$3 = Object.freeze({
  default: _assocDelete$1
});

var _stackDelete = createCommonjsModule(function (module) {
var assocDelete = interopDefault(require$$2$3);
...
var _assocGet = createCommonjsModule(function (module) {
var assocIndexOf = interopDefault(require$$0$11);
...
var _assocGet$1 = interopDefault(_assocGet);
...
var assocGet = interopDefault(require$$2$5);
...
var _assocHas = createCommonjsModule(function (module) {
var assocIndexOf = interopDefault(require$$0$11);
...
var _assocHas$1 = interopDefault(_assocHas);
...
var assocHas = interopDefault(require$$2$6);
...
var isNative = createCommonjsModule(function (module) {
var isFunction = interopDefault(require$$2$2),
    isHostObject = interopDefault(require$$1$7),
    isObjectLike = interopDefault(require$$0$7);
...
var isNative$1 = interopDefault(isNative);
...
var isNative = interopDefault(require$$0$15);
...
var getNative = interopDefault(require$$1$6);
...
var _mapClear = createCommonjsModule(function (module) {
var Hash = interopDefault(require$$1$5),
    Map = interopDefault(require$$2$7);
...
var _mapClear$1 = interopDefault(_mapClear);
...
var hashHas = interopDefault(require$$1$9);
...
var _mapDelete = createCommonjsModule(function (module) {
var Map = interopDefault(require$$2$7),
    assocDelete = interopDefault(require$$2$3),
    hashDelete = interopDefault(require$$1$8),
    isKeyable = interopDefault(require$$0$18);
...
var _mapDelete$1 = interopDefault(_mapDelete);


var require$$3$3 = Object.freeze({
  default: _mapDelete$1
});
...
var _mapGet = createCommonjsModule(function (module) {
var Map = interopDefault(require$$2$7),
    assocGet = interopDefault(require$$2$5),
    hashGet = interopDefault(require$$1$10),
    isKeyable = interopDefault(require$$0$18);
...
var _mapGet$1 = interopDefault(_mapGet);
...
var _mapHas = createCommonjsModule(function (module) {
var Map = interopDefault(require$$2$7),
    assocHas = interopDefault(require$$2$6),
...
var _mapHas$1 = interopDefault(_mapHas);
...
var _assocSet = createCommonjsModule(function (module) {
var assocIndexOf = interopDefault(require$$0$11);
...
var _assocSet$1 = interopDefault(_assocSet);
...
var _mapSet = createCommonjsModule(function (module) {
var Map = interopDefault(require$$2$7),
    assocSet = interopDefault(require$$2$9),
    hashSet = interopDefault(require$$1$12),
    isKeyable = interopDefault(require$$0$18);
...
var _mapSet$1 = interopDefault(_mapSet);
...
var mapClear = interopDefault(require$$4$2),
    mapDelete = interopDefault(require$$3$3),
    mapGet = interopDefault(require$$2$8),
    mapHas = interopDefault(require$$1$11),
    mapSet = interopDefault(require$$0$19);
...
var MapCache = interopDefault(require$$1$4),
    assocSet = interopDefault(require$$2$9);
...
var stackClear = interopDefault(require$$4$1),
    stackDelete = interopDefault(require$$3$2),
    stackGet = interopDefault(require$$2$4),
    stackHas = interopDefault(require$$1$3),
    stackSet = interopDefault(require$$0$13);
...
var arraySome = interopDefault(require$$0$20);
...
var Symbol = interopDefault(require$$1$13),
    Uint8Array = interopDefault(require$$3$4),
    equalArrays = interopDefault(require$$2$12),
    mapToArray = interopDefault(require$$1$14),
    setToArray = interopDefault(require$$0$21);
...
var baseTimes = interopDefault(require$$4$5),
    isArguments = interopDefault(require$$7),
    isArray = interopDefault(require$$0$8),
    isLength = interopDefault(require$$3$1),
    isString = interopDefault(require$$2$13);
...
var baseHas = interopDefault(require$$5$1),
    baseKeys = interopDefault(require$$4$4),
    indexKeys = interopDefault(require$$3$5),
    isArrayLike = interopDefault(require$$0$5),
    isIndex = interopDefault(require$$5$2),
    isPrototype = interopDefault(require$$0$23);
...
var baseHas = interopDefault(require$$5$1),
    keys = interopDefault(require$$0$22);
...
var Map = interopDefault(require$$2$7),
    Set = interopDefault(require$$1$15),
    WeakMap = interopDefault(require$$0$24);
...
var isLength = interopDefault(require$$3$1),
    isObjectLike = interopDefault(require$$0$7);
...
var Stack = interopDefault(require$$7$1),
    equalArrays = interopDefault(require$$2$12),
    equalByTag = interopDefault(require$$5),
    equalObjects = interopDefault(require$$4$3),
    getTag = interopDefault(require$$3$6),
    isArray = interopDefault(require$$0$8),
    isHostObject = interopDefault(require$$1$7),
    isTypedArray = interopDefault(require$$0$25);
...
var baseIsEqualDeep = interopDefault(require$$2$11),
    isObject = interopDefault(require$$0$6),
    isObjectLike = interopDefault(require$$0$7);
...
var Stack = interopDefault(require$$7$1),
    baseIsEqual = interopDefault(require$$2$10);
...
var _baseToPairs = createCommonjsModule(function (module) {
var arrayMap = interopDefault(require$$0$10);
...
var _baseToPairs$1 = interopDefault(_baseToPairs);


var require$$1$17 = Object.freeze({
  default: _baseToPairs$1
});

var toPairs = createCommonjsModule(function (module) {
var baseToPairs = interopDefault(require$$1$17),
    keys = interopDefault(require$$0$22);
...
var toPairs$1 = interopDefault(toPairs);
...
var isStrictComparable = interopDefault(require$$1$16),
    toPairs = interopDefault(require$$0$27);
...
var baseIsMatch = interopDefault(require$$1$2),
    getMatchData = interopDefault(require$$0$26);
...
var isObjectLike = interopDefault(require$$0$7);
...
var _baseCastPath = createCommonjsModule(function (module) {
var isArray = interopDefault(require$$0$8),
...
var _baseCastPath$1 = interopDefault(_baseCastPath);


var require$$8 = Object.freeze({
  default: _baseCastPath$1
});
...
var baseCastPath = interopDefault(require$$8),
    isKey = interopDefault(require$$0$33);
...
var baseGet = interopDefault(require$$0$29);
...
var baseSlice = interopDefault(require$$1$20),
    get = interopDefault(require$$0$28);
...
var baseCastPath = interopDefault(require$$8),
    ...
    isLength = interopDefault(require$$3$1),
    isString = interopDefault(require$$2$13),
    last = interopDefault(require$$1$19),
    parent = interopDefault(require$$0$36);
...
var baseHasIn = interopDefault(require$$1$18),
    hasPath = interopDefault(require$$0$35);
...
var baseIsEqual = interopDefault(require$$2$10),
    get = interopDefault(require$$0$28),
    hasIn = interopDefault(require$$0$34);
...
var baseProperty = interopDefault(require$$2$1),
    basePropertyDeep = interopDefault(require$$1$21),
    isKey = interopDefault(require$$0$33);
...
var baseMatches = interopDefault(require$$4),
    baseMatchesProperty = interopDefault(require$$3$7),
    identity = interopDefault(require$$2$14),
    isArray = interopDefault(require$$0$8),
    property = interopDefault(require$$0$37);
...
var createBaseFor = interopDefault(require$$0$38);
...
var baseFor = interopDefault(require$$1$24),
    keys = interopDefault(require$$0$22);
...
var baseForOwn = interopDefault(require$$1$23),
    createBaseEach = interopDefault(require$$0$39);
...
var baseEach = interopDefault(require$$4$6),
    isArrayLike = interopDefault(require$$0$5);
...
var arrayMap = interopDefault(require$$0$10),
    baseIteratee = interopDefault(require$$1$1),
    baseMap = interopDefault(require$$1$22),
    isArray = interopDefault(require$$0$8);
...
var flatMap = createCommonjsModule(function (module) {
var baseFlatten = interopDefault(require$$1),
    map = interopDefault(require$$0$9);
...
var flatMap$1 = interopDefault(flatMap);
...
var _baseFind = createCommonjsModule(function (module) {
/**
...
var _baseFind$1 = interopDefault(_baseFind);
...
var baseEach = interopDefault(require$$4$6),
    baseFind = interopDefault(require$$3$8),
    baseFindIndex = interopDefault(require$$2$15),
    baseIteratee = interopDefault(require$$1$1),
    isArray = interopDefault(require$$0$8);
...
var tracking$1 = interopDefault(tracking);
var pageview = tracking.pageview;
...
var menucard2_generated = createCommonjsModule(function (module) {
module.exports = {
    "categories": [
        {
...
var menucard2_generated$1 = interopDefault(menucard2_generated);


var require$$6 = Object.freeze({
    default: menucard2_generated$1
});
...
var LocalStorage = {
    ...
    readJson: function (key, defaultObject) {
...
var localStorage$1 = interopDefault(localStorage);
...
var modal$1 = interopDefault(modal);
var show = modal.show;
var hide = modal.hide;
...
var redux = interopDefault(require$$0$3);

var address = function (state, action) {
...
var openingHours = function (state, action) {
    ...
    var currentDay = action.date.getDay();
    var currentTime = action.date.getHours() * 100 + action.date.getMinutes();
    var currentOpeningHours = openingHoursPerDay[currentDay];
    var isOpen = currentTime >= currentOpeningHours[0] && currentTime <= currentOpeningHours[1];
...
var yml = interopDefault(require$$19);
console.log(yml);
...
interopDefault(require$$18).polyfill();


interopDefault(require$$16).init();



var Vue = interopDefault(require$$13);
var page = interopDefault(require$$12);
var redux = interopDefault(require$$0$3);
var flatMap = interopDefault(require$$10);
var find = interopDefault(require$$9);
var $ = interopDefault(require$$0);

var tracking = interopDefault(require$$7$2);
...
var menucard = interopDefault(require$$6);

var defaultState = { items: [] };

var shoppingCartStore = redux.createStore(function (state, action) {
    if ( state === void 0 ) state = defaultState;

    switch(action.type) {
        case 'ADD':
            var q = Object.assign({}, action.item);
            ...
            var x = Object.assign({}, state, { items: state.items.concat( [Object.assign({}, action.item)]) });
            return x;
        case 'REMOVE':
            return Object.assign({}, state, { items: state.items.filter(function (i) { return i.timestamp !== action.timestamp; }) });
        case 'DUPLICATE':
...
$(document).on('click', 'button[data-add-to-cart]', function (e) {
    ...
    var dish = find(menucard.dishes, function (d) { return d.id === id; });
    var type = dish.type;
...
var LocalStorage = interopDefault(require$$5$3);

var savedItems = LocalStorage.readJson('items');
shoppingCartStore.dispatch({ type: 'RESTORE', items: savedItems });


var shoppingCartTemplate = interopDefault(require$$4$7);
// import shoppingCartTemplate from './templates/shop-cart.html';

var orderModalHtml = interopDefault(require$$3$9)
...
var shoppingCartModel = new Vue({
    ...
    watch: {
        'address.city': function (_) { return LocalStorage.write('city', shoppingCartModel.address.city); },
        'address.name': function (_) { return LocalStorage.write('name', shoppingCartModel.address.name); },
        'address.street': function (_) { return LocalStorage.write('street', shoppingCartModel.address.street); },
        'address.phone': function (_) { return LocalStorage.write('phone', shoppingCartModel.address.phone); },
        notes: function (_) { return LocalStorage.write('notes', shoppingCartModel.notes); },
        items: function (_) { return LocalStorage.writeJson('items', shoppingCartModel.items); }
    },

    computed: {
        visibleItems: function() {
            return this.items.map(function (item) {
                var dish = find(menucard.dishes, function (d) { return d.id === item.dishId; });
                var variant = item.variant;
                var price = find(dish.variants, function (v) { return v.name === item.variant; }).price;
        ...
        totalPrice: function() {
            var x = this.items.map(function (item) {
                ...
                var price = find(dish.variants, function (v) { return v.name === item.variant; }).price;
                var extras = item.extras;
                var sumExtras = extras.reduce(function (prevSum, cur) { return prevSum + cur.price; }, 0);
        ...
        orderToSubmit: function() {
            ...
            var items = this.visibleItems.map(function (item) { return ({
                name: item.dish.name,
                variant: item.variant,
                price: item.price,
                extras: item.extras.map(function (extra) { return ({ name: extra.name, price: extra.price }); })
            }); });

            return { address: address, deliveryFee: deliveryFee, totalPrice: totalPrice, items: items };
        }
    },
    ...
    methods: {
        ...
        removeOrderItem: function (timestamp) {
            shoppingCartStore.dispatch({ type: 'REMOVE', timestamp: timestamp });
        },
        duplicateOrderItem: function (timestamp) {
        ...
        submitOrder: function (_) {
            // var orderModalHtml = require('./templates/order-modal.html');
            // var orderModalHtml = require('./templates/order-modal.html');
            var m = modal.show(orderModalHtml);
            var model = new Vue({
                el: m.el,
                data: {
                    orderPending: true,
            ...
            var data = shoppingCartModel.orderToSubmit;
...
var dishOptionsModalHtml = interopDefault(require$$2$16);
// import dishOptionsModalHtml from './templates/dish-options-modal.html';
var modal = interopDefault(require$$1$25);

var showDishOptionsModal = function (order) {
    var dish = find(menucard.dishes, function (d) { return d.id === order.dishId; });
    var m = modal.show(dishOptionsModalHtml);
    var model = new Vue({
        el: m.el,
        data: {
            dish: dish,
        ...
        computed: {
            ...
            totalPrice: function () {
                var base = find(dish.variants, function (v) { return v.name === order.variant; }).price;
                var extras = order.extras.reduce(function (prev, curr) { return curr.price + prev; }, 0);
                return base + extras;
            }
        },

        methods: {
            addExtra: function (category, name, price) {
                var alreadyAdded = order.extras.filter(function (x) { return x.category === category && x.name === name; }).length > 0;
                if (!alreadyAdded) {
                    order.extras.push({ category: category, name: name, price: price });
                }
            },
            removeExtra: function (extra) {
                order.extras = order.extras.filter(function (ex) { return ex.name !== extra.name || ex.category !== extra.category; });
            },
            cancel: function () {
                modal.hide();
                model.$destroy();
...
var newStore = interopDefault(require$$0$40);
